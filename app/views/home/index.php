...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT;?>/public/css/indexStyles.css" />
    <title>Guest Pro</title>
  </head>
  <body>
    <div class="div01">
      ...
      <header class="header">
        <nav>
          ...
          <a href="<?php echo URLROOT;?>/Users/login"><button class="btn">Book Now</button></a>
        </nav>
    ...
    <section class="section__container about__container" id="about">
      <div class="about__image">
        <img src="<?php echo URLROOT;?>/public/img/home/home1.jpeg" alt="about" />
      </div>
      ...
      <?php foreach($data as $room)  {?>
        <div class="room__card">
          <div class="room__card__image">
            <img src="<?php echo URLROOT;?>/public/img/rooms/<?php echo $room->mainImg;?>.jpg" alt="room" />
          ...
          <div class="room__card__details">
            <h4><?php echo $room->category;?></h4>
            <p>
              <?php  

              
              $amnt=explode(",",$room->amenities);
              ...
              // usort($amnt, 'sortByLength');
              
              for($i=0; $i<sizeof($amnt); $i++) {?>
                <span><i class="fa-solid fa-circle-check"></i><?php echo" ". $amnt[$i]?></span>
              <?php } ?>  
            </p>
    ...
    <footer class="footer" id="contact">
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          <h4>CONTACT US</h4>
          <ul class="footer__links">
            <li><a href="#">Guestpro@gmial.com</a></li>
          </ul>
      ...
      <div class="footer__bar">
        Copyright © 2024 Guest Pro ||  All rights reserved.
      </div>
    </footer>
