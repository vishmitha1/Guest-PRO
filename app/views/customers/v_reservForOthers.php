...
<!--'''''''''''''''''''''''' this is run on walkinreservation css '''''''''''''''''''''''''''''''''''''''''''''''''''' -->



    <div class="reservation-form-wrapper">

        <form action="<?php echo URLROOT;?>/Customers/placeReservationForOthers" method="post" >
        <div class="reservation_form">
            <div class="form-title">
                <h2>Reservation Details</h2>
            </div>

                 <?php if(isset($_SESSION['update_reserv_others'])){
                    ...
                    <div class="cus-name">
                        ...
                        <input type="text" name="customer_name" id="customer_name" value="<?php echo $item->customer_name;?>">
                    </div>
                    <div class="cus-email">
                        <span>Customer Email <i class="fa-solid fa-envelope-open-text"></i></span><br>
                        <input type="text" name="customer_email" id="customer_email" value="<?php echo $item ->email;?>">
                    </div>
                    <div class="cus-address">
                        <span>Customer Address <i class="fa-regular fa-address-card"></i></span><br>
                        <input type="text" name="customer_address" id="customer_address" value="<?php echo $item ->address;?>">
                    </div>

                    <div class="input-flield">
                        <span>Customer Phone <i class="fa-solid fa-phone"></i></span><br>
                        <input type="text" name="customer_phone" id="customer_phone" value="<?php echo $item ->phone;?>">
                    </div>

                    <div class="input-flield">
                        <span>Customer NIC <i class="fa-solid fa-id-card"></i></span><br>
                        <input type="text" name="customer_nic" id="customer_nic" value="<?php echo $item ->nic;?>">
                    </div>  
                ...
                <div class="input-flield">
                    <span>Customer NIC <i class="fa-solid fa-id-card"></i></span><br>
                    <input type="text" name="customer_nic" id="customer_nic" placeholder="Customer NIC" value="<?php echo $_SESSION['user_nic'];?>" >
                </div>  
