...
<script>
    ...
    function runPayment(){
        ...
        payhere.onCompleted = function onCompleted(orderId) {
            ...
            xhr.open("POST", "http://localhost/GuestPro/Customers/reservationPayment", true);
            xhr.setRequestHeader("Content-Type", "application/json");
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4) {
                    if (xhr.status == 200) {
                        console.log(xhr.responseText);
                        window.location.href="http://localhost/GuestPro/Customers/reservation";
        ...
        var payment = {
            ...
            "return_url": "http://localhost/GuestPro/Customers/reservationPayment",     // Important
            "cancel_url": "http://localhost/GuestPro/Customers/reservation",     // Important
