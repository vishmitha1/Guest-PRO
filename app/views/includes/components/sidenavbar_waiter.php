...
<body>
    <div class="side-bar">
        ...
        <div class="links">
            <a href="<?php echo URLROOT;?>/Customers/reservation"><i class="fa-solid fa-hotel"></i>Dashboard</a>
            <a href="<?php echo URLROOT;?>/Customers/reservation"><i class="fa-solid fa-hotel"></i>Pending Food Orders</a>
